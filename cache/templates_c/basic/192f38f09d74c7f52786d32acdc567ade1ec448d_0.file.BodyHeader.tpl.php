<?php
/* Smarty version 3.1.39, created on 2021-08-28 17:16:37
  from '/Applications/MAMP/htdocs/layouts/basic/modules/Vtiger/BodyHeader.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_612a5355c653c2_91229207',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '192f38f09d74c7f52786d32acdc567ade1ec448d' => 
    array (
      0 => '/Applications/MAMP/htdocs/layouts/basic/modules/Vtiger/BodyHeader.tpl',
      1 => 1625219224,
      2 => 'file',
    ),
  ),
...
function content_612a5355c653c2_91229207 (Smarty_Internal_Template $_smarty_tpl) {
...
}?> m-auto mb-0 px-3 py-1 text-center u-font-size-19px text-nowrap" role="alert"><i class="<?php if (empty(\Config\Main::$headerAlertIcon)) {?>fas fa-exclamation-triangle<?php } else {
echo \Config\Main::$headerAlertIcon;
}?>"></i><span class="font-weight-bold mx-3"><?php echo \Config\Main::$headerAlertMessage;?>
</span><i class="<?php if (empty(\Config\Main::$headerAlertIcon)) {?>fas fa-exclamation-triangle<?php } else {
echo \Config\Main::$headerAlertIcon;
}?>"></i></div><?php }?><div class="o-navbar__right ml-auto d-inline-flex flex-sm-nowrap"><?php if (!Settings_ModuleManager_Library_Model::checkLibrary('roundcube')) {
...
"></span><span data-id="<?php echo $_smarty_tpl->tpl_vars['MAIN_MAIL']->value['rcuser_id'];?>
" class="noMails"></span></div></a><?php } else { ?><div class="d-none d-xxl-block"><select id="mail-select" class="form-control-sm" title="<?php echo \App\Language::translate('LBL_SEARCH_MODULE',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
"><?php
...
" data-nomail="" class="dropdown-item js-mail-link px-2" data-js="click"><div class="d-flex w-100"><span class="mr-2"><?php echo $_smarty_tpl->tpl_vars['ITEM']->value['username'];?>
